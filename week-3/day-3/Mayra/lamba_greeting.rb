...
# yet open for extension. That means you should be able to add new functionality to an object or method without altering it.
...
spoken    =->(greeting) { return "#{greeting}."  }
shouted   =->(greeting) { return "#{greeting.upcase}!" }
whispered =->(greeting) { return "#{greeting.downcase}." }
